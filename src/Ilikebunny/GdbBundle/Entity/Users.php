 ...
 * Users
 *
 * @ORM\Table(name="users", uniqueConstraints={@ORM\UniqueConstraint(name="id_UNIQUE", columns={"id"}), @ORM\UniqueConstraint(name="nom_UNIQUE", columns={"nom"})} )}
 * @ORM\Entity
 */
class Users extends BaseUser {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Ilikebunny\GdbBundle\Entity\Group", fetch="EAGER")
     * @ORM\JoinColumns({
